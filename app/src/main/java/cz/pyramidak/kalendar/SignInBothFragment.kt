...
import cz.pyramidak.kalendar.databinding.FragmentSigninBothBinding
import cz.pyramidak.kalendar.firebase.MyFirebase

class SignInBothFragment : Fragment(){

    private lateinit var googleSignInClient: GoogleSignInClient
    private lateinit var firebaseAuth: FirebaseAuth

    private var _binding: FragmentSigninBothBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentSigninBothBinding.inflate(inflater, container, false)
        return binding.root
    }
